...
<?php var_export($demo); ?>
    ...
    <footer id="footer">
        ...
        <div class="credits float-right">
            <a href="http://github.com/atelierspierrot/mime-email">atelierspierrot/mime-email</a> package by <a href="https://github.com/atelierspierrot">Les Ateliers Pierrot</a> under <a href="http://opensource.org/licenses/GPL-3.0">GNU GPL v.3</a> license.
        </div>
    </footer>
